...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_file', default='LTE/lte_train', type=str, help='parsed log file')
    parser.add_argument('--log_normal', default='LTE/lte_normal', type=str, help='parsed log file of normal testing data')
    parser.add_argument('--log_abnormal', default='LTE/lte_abnormal', type=str, help='parsed log file of abnormal testing data')
